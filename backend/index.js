...
// // Handle undefined routes - FIXED VERSION - No wildcard character
// app.use((req, res) => {
//   res.status(404).json({
//     success: false,
...
const dotenv = require('dotenv');
const cors = require('cors');
// const mongoose = require('mongoose'); // Uncomment when ready
// const helmet = require('helmet');
// const rateLimit = require('express-rate-limit');
...
// Security middleware (uncomment when ready)
// app.use(helmet());
...
// ===== MOCK DATA (for testing until database is ready) =====
...
app.post('/api/bins/update', (req, res) => {
  ...
  bins[binIndex] = {
    ...bins[binIndex],
    fill_level: fill_level || bins[binIndex].fill_level,
    fire_alert: fire_alert !== undefined ? fire_alert : bins[binIndex].fire_alert,
...
// ===== MODULAR ROUTES (commented out until route files exist) =====
// app.use('/api/auth', require('./routes/auth'));
// app.use('/api/bins', require('./routes/bins'));
// app.use('/api/recycling', require('./routes/recycling'));
// app.use('/api/users', require('./routes/users'));
...
app.listen(PORT, () => {
  ...
  console.log('   • GET  /api/bins/all         - Get all bins');
  console.log('   • GET  /api/bins/status/:id  - Get specific bin');
  console.log('   • POST /api/bins/update      - Update bin (IoT)');
  console.log('   • GET  /api/recycling/centers - Get recycling centers');
  console.log('   • GET  /api/recycling/stats  - Recycling statistics');
